	...
	return (
		<div>
			...
			<div className={dm ? s.dmbackgroundAboutUs : s.backgroundAboutUs}>
				<div className={dm ? s.dmtituloEquipo : s.tituloEquipo}>
					Nuestro Equipo
				</div>
				<div className={dm ? s.dmcardsContainer : s.cardsContainer}>
					<div className={dm ? s.dmcard : s.card}>
						...
						<h2 className={dm ? s.dmnombreCompleto : s.nombreCompleto}>
							Ezequiel Gomez
						</h2>
						...
						<a href="https://github.com/EzequielGomez74">
							{" "}
							<FontAwesomeIcon
								className={dm ? s.dmgitHub : s.gitHub}
								icon={faGithub}
							/>{" "}
						</a>
						...
						<a href="https://www.linkedin.com/in/ezequiel-gomez-b9b563208/">
							{" "}
							<FontAwesomeIcon
								className={dm ? s.dmlinkedin : s.linkedin}
								icon={faLinkedin}
							/>{" "}
						</a>
					</div>
					...
					<div className={dm ? s.dmcard : s.card}>
						...
						<a href="https://www.linkedin.com/in/alberto-martinez-a0242b260/">
							<FontAwesomeIcon
								className={dm ? s.dmlinkedin : s.linkedin}
								icon={faLinkedin}
							/>{" "}
