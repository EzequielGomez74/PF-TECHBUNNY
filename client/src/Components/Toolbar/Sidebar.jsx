...
function Sidebar({ SideBar }) {
  return (
    <div className={SideBar ? `sidebar sidebar--open`: `sidebar`}>
      <NavLink className="sidebarNavLink" to='/dashboard'><li><FontAwesomeIcon icon={faChartSimple} /> Dashboard</li></NavLink>
      <NavLink className="sidebarNavLink" to='/dashboard/users'><li><FontAwesomeIcon icon={faUser} /> Usuarios</li></NavLink>
