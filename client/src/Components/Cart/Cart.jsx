...
function Cart() {
  ...
  return (
    <div>
      <NavBar />
      <section className={dm ? s.dmCartContainer : s.cartContainer}>
        {cart.length ? (
          <div>
            <div>
              {cart.map((p) => (
            ...
            <Link to="/payment">
              {" "}
              <button className={dm ? s.dmprocessPayment : s.processPayment}>
                Procesar Compra
              </button>{" "}
            </Link>
          </div>
          ...
          <div>
            ...
            <p className={dm ? s.dmnoProducts : s.noProducts}>
