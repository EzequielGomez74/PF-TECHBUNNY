...
import { completeProfile, updateOrderInfoById, updateUserInfo } from '../../redux/actions';
        ...
        <div>
            ...
            <div className={s.profileSection}>
                ...
                <div className={s.profileInfo}>
                    <span><strong>Nombre de usuario:</strong>&nbsp;&nbsp;&nbsp;&nbsp;  {user.name} </span>
                    <span><strong>Nombre:</strong>&nbsp;&nbsp;&nbsp;&nbsp;  {user.name} </span>
                    <span><strong>Apellido:</strong>&nbsp;&nbsp;&nbsp;&nbsp;  {user.name} </span>
