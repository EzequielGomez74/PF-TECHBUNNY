...
function Details() {
  ...
  const testProducts = [
    {
      ...
      image:
        "https://thotcomputacion.com.uy/wp-content/uploads/2015/07/ath.jpg",
      price: "325",
      stock: 12,
      soldCount: 5,
      brand: "Amd",
    ...
    },
    {
      ...
      image:
        "https://thotcomputacion.com.uy/wp-content/uploads/2015/01/3-1.jpg",
      price: "375",
      stock: 2,
      soldCount: 5,
      brand: "Amd",
    ...
    },
    {
      ...
      image:
        "https://thotcomputacion.com.uy/wp-content/uploads/2016/11/AMD-1-1-600x602.png",
      price: "900",
      stock: 4,
      soldCount: 7,
      brand: "Amd",
    ...
    },
    {
      ...
      image:
        "https://thotcomputacion.com.uy/wp-content/uploads/2017/07/AMD-5-1-600x602.jpg",
      price: "1090",
      stock: 4,
      soldCount: 7,
      brand: "Amd",
    ...
    },
    {
      ...
      image:
        "https://thotcomputacion.com.uy/wp-content/uploads/2021/10/xz10r-600x600.jpg",
      price: "1599.99",
      stock: 9,
      soldCount: 5,
      brand: "Amd",
  ...
  const currentProducts = testProducts.slice(
    indexOfFirstProduct,
    indexOfLastProduct
  );
          ...
          <div className={s.pagination}>
            {currentPage === 1 ? (
              <div className={s.pagbutton}>
                ...
                <button className={s.next} onClick={next}>
                  Next
                </button>
              </div>
            ) : (
