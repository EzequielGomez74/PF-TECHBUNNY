...
import { getProducts, postProduct, updateProduct, deleteProduct } from '../../../redux/actions'
...
function Products() {
  ...
  const bodyInsertar=(
    <div className={styles.modal}>
      ...
      <br />
      <TextField name="brand" className={styles.inputMaterial} label="Brand" onChange={handleChange}/>
      <br />
      <TextField name="price" className={styles.inputMaterial} label="Price" onChange={handleChange}/>
      <br />
      <TextField name="stock" className={styles.inputMaterial} label="Stock" onChange={handleChange}/>
      <br />
      <TextField name="category" className={styles.inputMaterial} label="Category" onChange={handleChange}/>
      <br />
      <TextField name="subcategory" className={styles.inputMaterial} label="Subcategory" onChange={handleChange}/>
      <br /><br />
      <div align="right">
  ...
  const bodyEditar=(
    <div className={styles.modal}>
      ...
      <TextField name="product_id" className={styles.inputMaterial} label="Id" onChange={handleChange} value={productSelected && productSelected.product_id}/>
      <br />
      <TextField name="name" className={styles.inputMaterial} label="Name" onChange={handleChange} value={productSelected && productSelected.name}/>
      <br />
      <TextField name="brand" className={styles.inputMaterial} label="Brand" onChange={handleChange} value={productSelected && productSelected.brand}/>
      <br />
      <TextField name="price" className={styles.inputMaterial} label="Price" onChange={handleChange} value={productSelected && productSelected.price}/>
      <br />
      <TextField name="stock" className={styles.inputMaterial} label="Stock" onChange={handleChange} value={productSelected && productSelected.stock}/>
      <br />
      <TextField name="category" className={styles.inputMaterial} label="Category" onChange={handleChange} value={productSelected && productSelected.category}/>
      <br />
      <TextField name="subcategory" className={styles.inputMaterial} label="Subcategory" onChange={handleChange} value={productSelected && productSelected.subcategory}/>
      <br />
      <br /><br />
      <div align="right">
  ...
  //Search Input
<<<<<<< HEAD
  const [productRows, setUserRows] = useState(products)
...
<<<<<<< HEAD
  const emptyRows = rowsPerPage - Math.min(rowsPerPage, productRows.length - page * rowsPerPage);
=======
...
>>>>>>> b687dc0fca529212cc210a60788a56ca71e2c198
          <TableContainer>
            <Table>
              ...
              <TableBody>
<<<<<<< HEAD
                {sortedRowInformation(productRows, getComparator(orderDirection, valueToOrderBy) ) 
=======
