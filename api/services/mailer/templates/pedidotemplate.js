...
async function ProdutsHTML (productos){
  ...
  for (let i = 0; i < productos.length; i++) {
    ...
    const productdata = await Product.findOne({where: { product_id: product.product_id}})
    product = { 
      ...product,
      image: productdata.image
    }
    productstotemplate += `<div class="u-row-container" style="padding: 0px;background-color: transparent">
  ...
  <table width="100%" cellpadding="0" cellspacing="0" border="0">
    <tr>
      <td class="v-text-align" style="padding-right: 0px;padding-left: 0px;" align="center">
        ...
        <img align="center" border="0" src="${product.image}" alt="Model" title="Model" style="outline: none;text-decoration: none;-ms-interpolation-mode: bicubic;clear: both;display: inline-block !important;border: none;height: auto;float: none;width: 100%;max-width: 201px;" width="201"/>
  ...
  <table id="u_content_heading_5" style="font-family:'Rubik',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <h1 class="v-text-align" style="margin: 0px; line-height: 140%; text-align: left; word-wrap: break-word; font-weight: normal; font-family: 'Rubik',sans-serif; font-size: 18px;"><strong>${product.product_name}   X ${product.count} U.</strong></h1>
  ...
  <table id="u_content_heading_6" style="font-family:'Rubik',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <h1 class="v-text-align" style="margin: 0px; color: #ba372a; line-height: 140%; text-align: left; word-wrap: break-word; font-weight: normal; font-family: 'Rubik',sans-serif; font-size: 18px;">Price: <strong> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;$${product.price}</strong></h1>
...
`  
  ...
  return productstotemplate; 
}

const pedidotemplate = async (userdata) => {
  let templateproductos = await ProdutsHTML(userdata.productos);
  let fulltemplate = `<!DOCTYPE HTML PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
  ...
  * {
  ...
  table, td { color: #000000; } @media (max-width: 480px) { #u_content_heading_2 .v-text-align { text-align: center !important; } #u_content_text_2 .v-container-padding-padding { padding: 0px 20px 20px !important; } #u_content_text_2 .v-text-align { text-align: center !important; } #u_content_heading_5 .v-text-align { text-align: center !important; } #u_content_text_9 .v-text-align { text-align: center !important; } #u_content_heading_6 .v-text-align { text-align: center !important; } #u_content_text_13 .v-container-padding-padding { padding: 0px 20px 20px !important; } #u_content_text_13 .v-text-align { text-align: center !important; } }
      </style>
  ...
  <div class="u-row-container" style="padding: 0px;background-color: #d7f136">
    <div class="u-row" style="Margin: 0 auto;min-width: 320px;max-width: 600px;overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;background-color: transparent;">
      <div style="border-collapse: collapse;display: table;width: 100%;height: 100%;background-color: transparent;">
        <!--[if (mso)|(IE)]><table width="100%" cellpadding="0" cellspacing="0" border="0"><tr><td style="padding: 0px;background-color: #d7f136;" align="center"><table cellpadding="0" cellspacing="0" border="0" style="width:600px;"><tr style="background-color: transparent;"><![endif]-->
  ...
  <p style="font-size: 14px; line-height: 140%;"><span style="font-size: 48px; line-height: 67.2px;">TECHBUNNY</span></p>
    </div>
  ...
  <table id="u_content_text_2" style="font-family:'Rubik',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="line-height: 170%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 170%; text-align: center;">A continuación, encontrará los detalles de la orden n° ${userdata.order_id}:</p>
    </div>
  ...
  <table style="font-family:'Rubik',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <h1 class="v-text-align" style="margin: 0px; color: #ba372a; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Rubik',sans-serif; font-size: 18px;"><strong>Total Price:</strong></h1>
  ...
  <table style="font-family:'Rubik',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <h1 class="v-text-align" style="margin: 0px; color: #ba372a; line-height: 140%; text-align: center; word-wrap: break-word; font-weight: normal; font-family: 'Rubik',sans-serif; font-size: 18px;">$${userdata.total.toFixed(2)}</h1>
  ...
  <table id="u_content_text_13" style="font-family:'Rubik',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div class="v-text-align" style="line-height: 170%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 170%; text-align: center;">Le informamos que su orden está siendo procesada y se enviará en breve. Le enviaremos un correo electrónico de seguimiento con el número de seguimiento una vez que su orden haya sido enviada.</p>
  <p style="font-size: 14px; line-height: 170%; text-align: center;">Si tiene alguna pregunta o inquietud con respecto a su orden, no dude en ponerse en contacto con nosotros.</p>
  <p style="font-size: 14px; line-height: 170%; text-align: center;">Muchas gracias por elegirnos.</p>
    </div>
  ...
  <p style="font-size: 14px; line-height: 140%;">All rights reserved.  TECHBUNNY</p>
  <p style="font-size: 14px; line-height: 140%;"> </p>
    </div>
